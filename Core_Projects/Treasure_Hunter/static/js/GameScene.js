...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("board", "gameboard.png", {
      frameWidth: 240,
      frameHeight: 320,
    });
    this.load.image("gold", "gold_coin.png");
    this.load.image("playerGold", "shiny_gold_coin.png");
    this.load.image("dig", "dugout_hole.png");
