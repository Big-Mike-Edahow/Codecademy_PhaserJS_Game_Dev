...
export default class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    let scoreText = this.add.text(140, 500, `Earnings: $${score}`, {
      fontSize: "25px",
      fill: "#FFF",
    });
    ...
    gameState.player = this.physics.add
      .sprite(240, 400, "bob-front")
      .setScale(1);
    this.physics.world.setBounds(0, 0, 480, 560); // Slightly above score
