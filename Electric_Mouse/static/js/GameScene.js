...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("Attack", "attack_button.png");
    this.load.image("Defend", "defend_button.png");
    this.load.image("Special", "special_button.png");
    const framePxWidth = 1500 / 9;
    this.load.spritesheet("Electric Mouse", "electric_mouse.png", {
    ...
    this.load.spritesheet("Red Owl", "red_owl.png", {
      frameWidth: framePxWidth,
      frameHeight: 132,
      endFrame: 8,
    });
    this.load.spritesheet("Blue Owl", "blue_owl.png", {
      frameWidth: framePxWidth,
      frameHeight: 132,
      endFrame: 8,
    });
    this.load.spritesheet("Psychic Hairless Cat", "psychic_cat.png", {
      frameWidth: framePxWidth,
      frameHeight: 148,
      endFrame: 11,
    });
  ...
  // Play the idle animation current enemy and Electric Mouse.
  pauseIdle() {
    setTimeout(function () {
