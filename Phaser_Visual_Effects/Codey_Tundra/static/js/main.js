...
class Level extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("bg1", "mountain.png");
  ...
  create() {
    ...
    gameState.player = this.physics.add.sprite(125, 110, "codey").setScale(0.75);
...
class Credits extends Phaser.Scene {
  ...
  preload() {
    this.load.setBaseURL("static");
    this.load.setPath("images/");
    this.load.image("background", "snowdunes.png");
    this.load.spritesheet("codey_sled", "codey_sled.png", {
      frameWidth: 81,
      frameHeight: 90,
    });
  }
  ...
  create() {
    gameState.backdrop = this.add
      .image(0, 0, "background")
      .setDisplaySize(500, 600)
      .setOrigin(0);
    ...
    // Creates the text on the credits screen:
    this.add.text(30, 50, "Codey Tundra!\nBy Mike Jackson", {
      fill: "#4D39E0",
      fontSize: "45px",
    });
  }
