...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("Chef");
    this.load.image("Customer-1");
    this.load.image("Customer-2");
    this.load.image("Customer-3");
    this.load.image("Customer-4");
    this.load.image("Customer-5");
    this.load.image("Floor-Server");
    this.load.image("Floor-Customer");
    this.load.image("Tray");
    this.load.image("Barrier");
    this.load.image("Star-full");
    this.load.image("Star-half");
    this.load.image("Star-empty");

    // Preload song.
    this.load.setPath("audio/music/");
    this.load.audio("gameplayTheme", "2-gameplayTheme.mp3");

    // // Preload SFX.
    this.load.setPath("audio/sfx/");
    this.load.audio("placeFoodSFX", "placeFood.mp3");
    this.load.audio("servingCorrectSFX", "servingCorrect.mp3");
    this.load.audio("servingIncorrectSFX", "servingIncorrect.mp3");
    this.load.audio("servingEmptySFX", "servingEmpty.mp3");
    this.load.audio("fiveStarsSFX", "fiveStars.mp3");
    this.load.audio("nextWaveSFX", "nextWave.mp3");
  }
